...
const NavContent = () => {
  ...
  return (
    <div className="relative -top-20">
      ...
      >
        <div 
        className="flex justify-around items-center text-xl px-4 lg:px-8 py-4"
        >
          {/* Logo Section */}
          <div className="cursor-pointer">
            <h1 className="font-bold text-2xl lg:text-3xl leading-relaxed tracking-wider">
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`cursor-pointer transition-colors duration-300 font-semibold ${
                  activeMenu === link.path ? "text-red-700" : "text-gray-500 hover:text-red-700"
                }`}
              >
                {link.name}
              </Link>
...
const Nav = () => (
  <Router>
    <NavContent />
    <div className="mt-20"> {/* Pushes content below the navbar */}
      <Routes>
